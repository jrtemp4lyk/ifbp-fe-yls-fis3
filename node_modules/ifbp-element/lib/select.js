...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _select = __webpack_require__(518);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _selectDropdown = __webpack_require__(520);
	...
	var _locale3 = __webpack_require__(70);
	...
	exports.default = {
	  ...
	  computed: {
	    ...
	    multiCurrentLabel: function multiCurrentLabel() {
	      var label = "";
	  ...
	  watch: {
	    ...
	    value: function value(val) {
	      ...
	      this.$emit("change", val, this.currentOption);
	  ...
	  updated: function updated() {
	    if (this.editable && this.$refs.popper) {
	      this.$refs.popper.minWidth = this.$el.getBoundingClientRect().width + "px";
	    }
	  },
	  beforeDestroy: function beforeDestroy() {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.showFlag === 'tooptip'),
	      expression: "showFlag === 'tooptip'"
	    }],
	    attrs: {
	      "content": _vm.selectedLabel
	    }
	  }), _c('ifbp-tooltip', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.showFlag === 'tooptipMulti'),
	      expression: "showFlag === 'tooptipMulti'"
	    }],
	    attrs: {
	      "content": _vm.multiCurrentLabel
	    }
	  }), _c('div', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.showFlag === 'base'),
	      expression: "showFlag === 'base'"
	    }]
	  }, [(_vm.multiple) ? _c('div', {
	    ref: "tags",
