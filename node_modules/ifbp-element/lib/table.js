...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/utils/resize-event");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/mixins/locale");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/utils/dom");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/utils/popup");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/checkbox");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/utils/scrollbar-width");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/tag");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/tooltip");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _table = __webpack_require__(577);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _resizeEvent = __webpack_require__(56);

	var _locale = __webpack_require__(69);

	var _locale2 = _interopRequireDefault(_locale);

	var _tableStore = __webpack_require__(579);

	var _tableStore2 = _interopRequireDefault(_tableStore);

	var _tableLayout = __webpack_require__(582);

	var _tableLayout2 = _interopRequireDefault(_tableLayout);

	var _tableBody = __webpack_require__(583);
	...
	var _tableFooter = __webpack_require__(590);

	var _tableFooter2 = _interopRequireDefault(_tableFooter);

	var _util = __webpack_require__(580);

	var _mttableBody = __webpack_require__(591);

	var _mttableBody2 = _interopRequireDefault(_mttableBody);
	...
	exports.default = {
	  ...
	  components: {
	    ...
	    mtTableBody: _mttableBody2.default
	  },

	  methods: {
	    sOnresize: function sOnresize() {
	      if (!this.$refs.elTable) {
	        return;
	      }
	      this.tableWidth = this.$refs.elTable.clientWidth;

	      var id = this.isChangeLayout ? 'elTable' : 'mElTable';
	      // this.cclientWidth = document.body.clientWidth;
	      var vm = this;
	      vm.cclientWidth = vm.$el.clientWidth;
	      if (vm.cclientWidth <= 550) {
	        vm.isChangeLayout = false;
	      } else {
	        vm.isChangeLayout = true;
	        if (vm.cclientWidth > 550 && vm.cclientWidth < 768) {
	          // vm.isChangeLayoutHide = true;
	          vm.columnsShow = 4;
	        }
	        if (vm.cclientWidth >= 768 && vm.cclientWidth <= 868) {
	          vm.columnsShow = 5;
	          // vm.isChangeLayoutHide = true;
	        }
	        if (vm.cclientWidth > 868 && vm.cclientWidth <= 979) {
	          // vm.isChangeLayoutHide = true;
	          vm.columnsShow = 6;
	        }
	      }
	    ...
	    bindEvents: function bindEvents() {
	      ...
	      var refs = this.$refs;
	      this.bodyWrapper.addEventListener('scroll', (0, _throttle2.default)(50, function () {
	        self.expandLeft = this.scrollLeft;
	      ...
	      if (this.fit) {
	        this.windowResizeListener = (0, _throttle2.default)(0, function () {
	    ...
	    expandRow: function expandRow(row) {
	      ...
	      if (expandRows.length === 1 && expandRows[0] === row) {
	        return;
	      }
	      this.closeExpandRow();
	      this.handleExpandClick(row);
	    },
	    closeExpandRow: function closeExpandRow() {
	      var expandRows = this.store.states.expandRows;
	      if (expandRows.length > 0) {
	        this.handleExpandClick(expandRows[0]);
	      }
	    },
	    handleExpandClick: function handleExpandClick(row) {
	      var _this3 = this;

	      // 由于table初始化隐藏再显示时会导致$refs.tableBody不存在，因此将tableBody中的方法在此处进行实现
	      // 此处要求调用时必须设置了expand列，即isExpandTable为true
	      this.store.commit('toggleRowExpanded', row);
	      this.$nextTick(function () {
	        var trs = document.querySelectorAll('.tableExpandSet');
	        for (var i = 0; i < trs.length; i++) {
	          trs[i].style.width = _this3.$el.offsetWidth + 'px';
	          trs[i].style.display = 'inline-table';
	          trs[i].style.position = 'relative';
	          trs[i].style.left = _this3.expandLeft + 'px';
	        }
	      });
	    },
	    ...
	    checkIfFormatNeeded: function checkIfFormatNeeded() {
	      var idLabel = this.treeProperties.id;
	      var pidLabel = this.treeProperties.pid;
	      var childrenLabel = this.treeProperties.children;
	      var needFormat = true;
	  ...
	  created: function created() {
	    ...
	    if (this.tableTree) {
	      if (this.checkIfFormatNeeded()) {
	        this.store.commit('setTreeProperties', this.treeProperties);
	      }
	      this.store.commit('setTableTree', true);
	  ...
	  computed: {
	    ...
	    treeProperties: function treeProperties() {
	      return {
	        id: this.treePropertiesId,
	        pid: this.treePropertiesPid,
	        children: 'children'
	      };
	    }
	  },
	  ...
	  mounted: function mounted() {
	    ...
	    this.$ready = true;
	    if (this.adaptiveMobile) {
	      this.sOnresize();
	      (0, _resizeEvent.addResizeListener)(this.$el, this.sOnresize);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tableTree = __webpack_require__(581);
	...
	TableStore.prototype.mutations = {
	  setData: function setData(states, data) {
	    ...
	    // for tree table
	    if (states.isTableTree) {
	      var backupData = states.data || [];
	      if (states.treeProperties) {
	        backupData = _tableTree2.default.transDataToTree(backupData, states.treeProperties);
	      }
	      states.data = _tableTree2.default.formatTreeData(backupData);
	    }
	  ...
	  rowSelectedChanged: function rowSelectedChanged(states, row) {
	    ...
	    var nowRow = rows[this.states.data.indexOf(row)];
	    if (nowRow) {
	      var selected = selection.indexOf(row);
	      if (selected > -1) {
	        nowRow.classList.add('select-row');
	      } else {
	        nowRow.classList.remove('select-row');
	      }
	    }
	    /** 增加选中的背景色  end */
	    if (changed) {
	  ...
	  // 设置是否为树表模式
	  setTableTree: function setTableTree(states, isTableTree) {
	    if (typeof isTableTree === 'boolean') {
	      states.isTableTree = isTableTree;
	    }
	  },


	  // 处理树表展开与收起
	  toggleTreeExpand: function toggleTreeExpand(states, row) {
	    var currentNodeId = row._treeNodeId;
	    var currentNodeIndex = states.data.indexOf(row);
	    if (row._treeExpanded) {
	      states.data = states.data.filter(function (item) {
	        // 父节点 id 数组中包含当前操作节点的 id 时, 应去除
	        return !item._treeParentNodeIds || item._treeParentNodeIds.indexOf(currentNodeId) === -1;
	      });
	    } else {
	      if (!row.children || !row.children.length) {
	        return;
	      }
	      var prepend = states.data.slice(0, currentNodeIndex + 1);
	      var append = states.data.slice(currentNodeIndex + 1);
	      var children = _tableTree2.default.setParentId(row.children, currentNodeId);
	      states.data = prepend.concat(children, append);
	    }
	    row._treeExpanded = !row._treeExpanded;
	  },


	  // 格式化数据为树结构
	  setTreeProperties: function setTreeProperties(states, treeProperties) {
	    states.treeProperties = treeProperties;
	  }
	  // transDataToTree(states, { treeData: data, treeProperties: treeProperties }) {
	  //   states.data = TableTree.transDataToTree(data, treeProperties);
	  // }
	...
	TableStore.prototype.getSelection = function () {
...
/***/ (function(module, exports) {
	...
	function formatTreeData(data) {
	  ...
	  setTreeLevel(resultData);
	  setTreeNodeId(resultData);
	  return resultData;
	}

	// 设置树表的层级, 用于空格占位符和展开 icon
	function setTreeLevel(data, level) {
	  var _treeLevel = typeof level === 'number' ? level + 1 : 0;
	  data.forEach(function (row) {
	...
	function setTreeNodeId(data) {
	  var _treeNodeId = 0;
	  var _setTreeNodeId = function _setTreeNodeId(_data) {
	    _data = _data || [];
	...
	function transDataToTree(data, properties) {
	  ...
	  var group = function group(nodes) {
	    var groups = {};
	  ...
	  var getChildren = function getChildren(groups, id) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _scrollbarWidth = __webpack_require__(502);
	...
	var TableLayout = function () {
	  ...
	  TableLayout.prototype.update = function update() {
	    ...
	    var bodyWidth = this.table.$el.clientWidth - 1; // 解决默认显示多1px导致存在滚动条的问题
	    var bodyMinWidth = 0;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tooltip = __webpack_require__(543);
	...
	exports.default = {
	    ...
	    return h(
	      ...
	      [h(
	        ...
	        [this._l(this.columns, function (column, cellIndex) {
	          if (!_this.columnsShow || cellIndex < _this.columnsShow) {
	            if (column.type !== "noIconExpand") {
	              return h(
	                'col',
	                {
	                  attrs: {
	          ...
	          return [h(
	            ...
	            [_this._l(_this.columns, function (column, cellIndex) {
	              if (column.type === "expand" || column.type === "noIconExpand") {
	                _this.isExpandTable = true;
	                if (column.type === "noIconExpand") {
	                  _this.noIconExpand = true;
	                }
	              }
	              if (!_this.columnsShow || cellIndex < _this.columnsShow) {
	                if (column.type !== "noIconExpand") {
	                  return h(
	                    ...
	                    // for table tree
	                    // 判断是否为树表模式, 且为第一列
	                    _this.store.states.isTableTree && cellIndex === 0 ? h(
	                      'div',
	                      {
	                        // 根据层级设置左填充
	                        style: 'margin-left: ' + (row._treeLevel + 1) * 10 + 'px;' + 'float: left; margin-top: 6px;'
	                        // 根据row的属性, 添加各种类的判别
	                        , 'class': (row.children && row.children.length ? 'el-tree-node__expand-icon ' : '') + (row._treeExpanded ? 'expanded ' : '') + (!row.children || !row.children.length ? 'is-leaf ' : ''),
	                        on: {
	                          'click': function click($event) {
	                            return _this.handleTreeExpandClick($event, row);
	                          }
	                        }
	                      },
	                      [!row.children || !row.children.length ? h(
	                        'span',
	                        { style: 'display: inline-block; width: 7px; height: 12px;' },
	                        []
	                      ) : '']
	                    ) : '',
	                    // 原始渲染表格逻辑
	            ...
	            'tr',
	            { 'class': 'tableExpandSet' },
	            [h(
	              'td',
	              {
	                attrs: { colspan: _this.isExpandTable && _this.noIconExpand ? _this.columns.length - 1 : _this.columns.length },
	  ...
	  watch: {
	    ...
	    tableWidth: function tableWidth(val) {
	      if (this.isExpandTable) {
	        var trs = document.querySelectorAll('.tableExpandSet');
	        for (var i = 0; i < trs.length; i++) {
	          trs[i].style.width = this.tableWidth + 'px';
	          trs[i].style.display = 'inline-table';
	          trs[i].style.position = 'relative';
	          trs[i].style.left = this.expandLeft + 'px';
	        }
	      }
	    },
	    expandLeft: function expandLeft(val) {
	      var self = this;
	      var setExpandLeft = function setExpandLeft(val) {
	        if (self.isExpandTable) {
	          var trs = document.querySelectorAll('.tableExpandSet');
	          for (var i = 0; i < trs.length; i++) {
	            trs[i].style.position = 'relative';
	            trs[i].style.left = val + 'px';
	          }
	        }
	      };
	      (0, _throttle2.default)(100, setExpandLeft(val));
	    }
	  },
	  ...
	  methods: {
	    ...
	    handleClick: function handleClick(event, row) {
	      this.store.commit('setCurrentRow', row);
	      if (this.table.rowClickExpandForm) {
	        this.handleExpandClick(row);
	      }
	    ...
	    handleExpandClick: function handleExpandClick(row, event) {
	      var _this2 = this;
	      ...
	      if (this.isExpandTable) {
	        ...
	        this.store.commit('toggleRowExpanded', row);
	        this.$nextTick(function () {
	          if (_this2.isExpandTable) {
	            var trs = document.querySelectorAll('.tableExpandSet');
	            for (var i = 0; i < trs.length; i++) {
	              trs[i].style.width = _this2.tableWidth + 'px';
	              trs[i].style.display = 'inline-table';
	              trs[i].style.position = 'relative';
	              trs[i].style.left = _this2.expandLeft + 'px';
	            }
	          }
	        });
	      } else {
	    ...
	    // 树父节点点击
	    handleTreeExpandClick: function handleTreeExpandClick(event, row) {
	      console.log(JSON.stringify(row));
	      event && event.stopPropagation();
	      if (!row.children || !row.children.length) {
	        return;
	      }
	      this.store.commit('toggleTreeExpand', row);
	    }
	  }
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _filterPanel = __webpack_require__(585);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _checkboxGroup = __webpack_require__(588);
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/checkbox-group");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	            ...
	            [_this._l(_this.columns, function (column, cellIndex) {
	              ...
	              [_this._l(_this.columns, function (column, cellIndex) {
	                ...
	                if (!(column.type === 'expand' || column.type === 'index' || column.type === 'selection' || column.type === 'noIconExpand')) {
	                  return h(
	                    'div',
	                    { style: 'padding:8px;clear: both;' },
	                    [h(
	                      'span',
	                      { style: _this.elcolumnStyle2[column.property] ? _lodash2.default.assign(_this.elcolumnStyle2[column.property].label, { 'width': '20%', 'display': 'block', 'float': 'left' }) : { 'width': '20%', 'display': 'block', 'float': 'left' } },
	                      [column.label, ':']
	                    ), h(
	                      'div',
	                      { style: _this.elcolumnStyle2[column.property] ? _lodash2.default.assign(_this.elcolumnStyle2[column.property].content, { 'float': 'right', 'width': '80%', 'text-align': 'right' }) : { 'float': 'right', 'width': '80%', 'text-align': 'right' } },
	                      [column.renderCell.call(_this._renderProxy, h, { row: row, column: column, $index: $index, store: _this.store, _self: _this.context || _this.table.$vnode.context }, columnsHidden[cellIndex])]
	                    )]
	                  );
	                }
	  ...
	  computed: {
	    elcolumnStyle2: function elcolumnStyle2() {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {}, [_c('div', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	      value: (_vm.isChangeLayout),
	      expression: "isChangeLayout"
	    }],
	    ref: "elTable",
	  ...
	  }, [_vm._t("empty")], 2)]) : _vm._e()], 1), (_vm.showSummary) ? _c('div', {
	    directives: [{
	      name: "show",
	      rawName: "v-show",
	    ...
	    staticClass: "el-table__empty-text"
	  }, [_vm._t("empty")], 2)]) : _vm._e()], 1)]) : _vm._e()])
	},staticRenderFns: []}
