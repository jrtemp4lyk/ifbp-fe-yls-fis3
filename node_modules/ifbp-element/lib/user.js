...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _user = __webpack_require__(730);
...
/***/ (function(module, exports) {
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    handleThemeChange: function handleThemeChange(val) {
	      var item = this.themeArray.filter(function (v) {
	        return v.code === val;
	      })[0];
	      this.$set(this.settings, 'themeName', item.name || '');
	    },
	    openTheme: function openTheme() {
	      this.$set(this.settings, 'themeCode', u.getCookie('ifbp-theme') || 'default');
	    ...
	    changeSettings: function changeSettings() {
	      ...
	      // this.saveSettingsData(this.settings).then(() => {
	      //   window.history.go(0);
	      // });
	      window.history.go(0);
	    },
	    saveSettingsData: function saveSettingsData(settings) {
	      var data = {
	    ...
	    settingsData: {
	      handler: function handler(val) {
	        ...
	        Object.keys(this.settings).forEach(function (key) {
	          _this2.settings[key] = val[key] === undefined ? '' : val[key];
	        });
	      },
	      deep: true
	    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', [_c('ul', {
	    ...
	    on: {
	      "change": _vm.handleThemeChange
	    },
	    model: {
	      value: (_vm.settings.themeCode),
	      callback: function($$v) {
	        _vm.settings.themeCode = $$v
	      },
	      expression: "settings.themeCode"
	    }
	  }, _vm._l((_vm.themeArray), function(item) {
	    return _c('el-option', {
	      attrs: {
	        "label": item.name,
	        "value": item.code
	    ...
	    model: {
	      value: (_vm.settings.showTabs),
	      callback: function($$v) {
	        _vm.settings.showTabs = $$v
	      },
	      expression: "settings.showTabs"
	    }
	  }, [_c('el-radio', {
	    attrs: {
	      "label": true
