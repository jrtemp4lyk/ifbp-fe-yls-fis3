...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/locale");
...
/***/ (function(module, exports) {
	...
	module.exports = require("ifbp-element/lib/utils/util");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _treeStore = __webpack_require__(380);
	...
	exports.default = (_name$mixins$componen = {
	  ...
	  components: {
	    MbTreeNode: __webpack_require__(383)
	  },
	  ...
	  methods: {
	    ...
	    TreeGoBack: function TreeGoBack() {
	      this.store.root.level -= 1;
	...
	}, _name$mixins$componen['computed'] = {
	  tBack: function tBack() {
	    var tBack = false;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _node = __webpack_require__(381);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _merge = __webpack_require__(227);
	    ...
	    NodeContent: {
	      ...
	      render: function render(h) {
	        ...
	        return parent.renderContent ? parent.renderContent.call(parent._renderProxy, h, { _self: parent.tree.$vnode.context, node: node, data: data, store: store }) : h(
	          'span',
	          { 'class': 'el-tree-node__label', style: 'float:left;' },
	          [this.node.label]
	        );
	      }
	    }
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {
	    ...
	    staticClass: "TreeBack",
	    on: {
	      "click": _vm.TreeGoBack
	    }
	  }, [_c('i', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _tree = __webpack_require__(637);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _treeStore = __webpack_require__(639);
	...
	var _mbTree = __webpack_require__(378);

	var _mbTree2 = _interopRequireDefault(_mbTree);
	...
	exports.default = {
	  ...
	  components: {
	    ElTreeNode: __webpack_require__(642),
	    MbTreeNode: __webpack_require__(378)
	  },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _node = __webpack_require__(640);
	...
	var TreeStore = function () {
	  function TreeStore(options) {
	    ...
	    this.nodesMap = {};
	    this.data = this.transData(this.data);
	    this.root = new _node2.default({
	      data: this.data,
	      store: this
	    });
	  ...
	  TreeStore.prototype.transData = function transData(data) {
	    if (this.props.id && this.props.pid) {
	      ...
	      var _getChildren = function _getChildren(groups, id) {
	        ...
	        if (nowGroup) {
	          for (var i = 0; i < nowGroup.length; i++) {
	            ...
	            var nowLabel = nowNode[label];
	            var child = {};
	            child['data'] = nowNode;
	            child[label] = nowLabel;
	            child.children = _getChildren(groups, nowId);
	            children.push(child);
	          }
	        }
	        delete groups[id];
	      ...
	      var newdata = [];
	      var idField = this.props.id;
	      var pidField = this.props.pid;
	      var label = this.props.label;

	      var groups = group(data);

	      newdata = _getChildren(groups, 'root$#@_');

	      for (var key in groups) {
	        newdata = newdata.concat(_getChildren(groups, key));
	      }
	      data = newdata;
	    }
	    return data;
	  ...
	  TreeStore.prototype.deregisterAllNodes = function deregisterAllNodes() {
	    this.nodesMap = [];
	  };
	  ...
	  TreeStore.prototype.getAllChildNodes = function getAllChildNodes() {
	    var allChildNodes = [];
	    var traverse = function traverse(node) {
	      var childNodes = node.root ? node.root.childNodes : node.childNodes;

	      childNodes.forEach(function (child) {
	        allChildNodes.push(child.data);
	        traverse(child);
	      });
	    };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Node = function () {
	  ...
	  Node.prototype.removeAllChild = function removeAllChild() {
	    this.store && this.store.deregisterAllNodes();
	    this.childNodes = [];
	    this.updateLeafState();
	  };
	  ...
	  Node.prototype.removeSelf = function removeSelf() {
	    this.parent.removeChildByData(this.data);
	  };
	  ...
	  Node.prototype.getBaseData = function getBaseData() {
	  ...
	  Node.prototype.getChildren = function getChildren() {
	    ...
	    if (childNodes && childNodes.length > 0) {
	      for (var i = 0; i < childNodes.length; i++) {
	        childRenData.push(childNodes[i].data);
	      }
	    }
	    return childRenData;
	  };
	  ...
	  //   var childrenBaseData = [];
	  //   if(children && children instanceof Array && children.length > 0){
	  //     for(var i = 0; i < children.length; i++){
	  //       var baseData = children[i].getBaseData();
	  //       childrenBaseData.push(baseData);
	  //     }
	  //   }
	  //   return childrenBaseData;
	  // }

	  Node.prototype.getChildrenBaseData = function getChildrenBaseData() {
	    var children = this.getChildren();
	    var childrenBaseData = this.getBaseDataByNodes(children);
	    return childrenBaseData;
	  };

	  Node.prototype.getAllChildren = function getAllChildren() {
	    var allChildNodes = [];
	    var traverse = function traverse(node) {
	      var childNodes = node.root ? node.root.childNodes : node.childNodes;
	  ...
	  Node.prototype.getAllChildrenBaseData = function getAllChildrenBaseData() {
	    var allChildren = this.getAllChildren();
	    var allChildrenBaseData = this.getBaseDataByNodes(allChildren);
	    return allChildrenBaseData;
	  };

	  Node.prototype.getBaseDataByNodes = function getBaseDataByNodes(nodes) {
	    var baseDatas = [];
	    if (nodes && nodes instanceof Array && nodes.length > 0) {
	      for (var i = 0; i < nodes.length; i++) {
	        var nowNode = nodes[i];
	        var baseData = nowNode.data;
	...
	exports.default = {
	  ...
	  methods: {
	    ...
	    getAllChildren: function getAllChildren() {
	      return this.node.getAllChildren();
	    },
	    getAllChildrenBaseData: function getAllChildrenBaseData() {
	      return this.node.getAllChildrenBaseData();
	    },
	    getChildren: function getChildren() {
	      return this.node.getChildren();
	    },
	    getChildrenBaseData: function getChildrenBaseData() {
	      return this.node.getChildrenBaseData();
	    },
	    getBaseData: function getBaseData() {
	      return this.node.getBaseData();
	    },
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  return _c('div', {}, [(_vm.tflag) ? _c('div', {
	    staticClass: "el-tree",
	    class: {
	      'el-tree--highlight-current': _vm.highlightCurrent
	    }
	    ...
	    staticClass: "el-tree__empty-text"
	  }, [_vm._v(_vm._s(_vm.emptyText))])]) : _vm._e()], 2) : _c('div', {}, [_c('mb-tree', {
	    staticStyle: {
