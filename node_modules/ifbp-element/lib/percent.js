...
/***/ (function(module, exports, __webpack_require__) {
	...
	var update = __webpack_require__(11)("28e5816f", content, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\n.errorFormat[data-v-7df6d2af] {border: 1px solid #E60012;\n}\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _calcTextareaHeight = __webpack_require__(226);
	...
	exports.default = {
	  ...
	  methods: {
	    value2CurrentValue: function value2CurrentValue(value) {
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [(_vm.editable === false) ? _c('ifbp-tooltip', {
	    attrs: {
	      "content": _vm.currentValue
	    }
	  }) : [(_vm.type === 'textarea') ? _c('textarea', _vm._b({
	    ref: "textarea",
	  ...
	  }, 'textarea', _vm.$props)) : [(_vm.$slots.prepend) ? _c('div', {
	  ...
	  }) : _vm._e()]), (_vm.type === 'text') ? _c('input', _vm._b({
	    ref: "input",
	  ...
	  }, 'input', _vm.$props)) : (_vm.type === 'money') ? _c('input', {
	    staticClass: "el-input__inner",
	    attrs: {
	      "type": "text"
	    },
	  ...
	  }, 'input', _vm.$props))], (_vm.validating) ? _c('i', {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(11)("c7cb2b30", content, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.default = {
	  ...
	  methods: {
	    value2CurrentValue: function value2CurrentValue(value) {
	      value = this.setformat(value, this.decimals, this.separator);
	      var realValue = value;
	      if (this.separator) {
	    ...
	    setformat: function setformat(number, decimals, separator) {
	      if (isNaN(number)) {
	        return "";
	      }
	      ...
	      if (separator) {
	        var digitsRE = /(\d{3})(?=\d)/g;
	        var stringified = number.toFixed(decimals);
	        var int = stringified.slice(0, -1 - decimals);
	        var i = int.length % 3;
	        var head = i > 0 ? int.slice(0, i) + (int.length > 3 ? separator : "") : "";
	        var float = decimals || decimals === 0 ? stringified.slice(-1 - decimals) : "";
	        var sign = number < 0 ? "-" : "";
	        returnValue = sign + head + int.slice(i).replace(digitsRE, "$1" + separator) + float;
	      } else if (!separator) {
	        returnValue = isNaN(number) ? "" : decimals || decimals === 0 ? number.toFixed(decimals) : number;
	      }
	      return returnValue;
	    },
	    handleFocus: function handleFocus(event) {
	    ...
	    handleBlur: function handleBlur(event) {
	      var formatValue = this.setformat(this.currentValue, this.decimals, this.separator) + "";
	      var reg = new RegExp(this.separator, "g");
	    ...
	    handleInput: function handleInput(event) {
	      ...
	      if (value && value.indexOf && this.decimals !== 0 && this.decimals !== "0") {
	        if (value.indexOf(".") !== value.lastIndexOf(".")) {
	          newVal = value.substr(0, value.length - 1);
	        } else if (value.indexOf(".") === value.lastIndexOf(".") && value.indexOf(".") === value.length - 1) {
	          return;
	        } else if (value.lastIndexOf("0") === value.length - 1) {
	          return;
	        }
	      }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _percent = __webpack_require__(462);
	...
	_percent2.default.install = function (Vue) {
	  Vue.component(_percent2.default.name, _percent2.default);
	};

	exports.default = _percent2.default;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(11)("341eef65", content, true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _number = __webpack_require__(434);
	...
	exports.default = {
	  ...
	  methods: {
	    value2CurrentValue: function value2CurrentValue(value) {
	      ...
	      if (realValue) {
	        realValue = parseFloat(realValue) / 100;
	      }
	      this.$emit("input", realValue);
	      this.setCurrentValue(value);
	    },
	    percentSetformat: function percentSetformat(value) {
	      if (isNaN(value)) {
	        return "";
	      }
	      ...
	      var formatValue = this.setformat(value, this.decimals, this.separator);
	      if (this.separator) {
	        var reg = new RegExp(this.separator, "g");
	        formatValue = formatValue.replace(reg, "");
	      }
	      var powValue = 1000;
	      if (this.decimals > 0) {
	        powValue = Math.pow(10, this.decimals);
	      }
	      formatValue = Math.round(parseFloat(formatValue) * 100 * powValue) / powValue;
	      var formatValue = this.setformat(formatValue, null, this.separator);
	      if (formatValue) {
	        return formatValue + "%";
	      } else {
	        return "";
