...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _money = __webpack_require__(430);
	...
	_money2.default.install = function (Vue) {
	  Vue.component(_money2.default.name, _money2.default);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(content.locals) module.exports = content.locals;
	// add the styles to the DOM
	var update = __webpack_require__(11)("467f8dd5", content, true);
	...
	exports.default = {
	  ...
	  methods: {
	    value2CurrentValue: function value2CurrentValue(value) {
	      ...
	      var realValue = value.replace(this.symbol, "");
	      if (this.separator) {
	    ...
	    moneySetformat: function moneySetformat(value) {
	      var formatValue = this.setformat(value, this.decimals, this.separator);
	      if (formatValue) {
	        return this.symbol + formatValue;
	      } else {
	        return "";
	      }
	    }
